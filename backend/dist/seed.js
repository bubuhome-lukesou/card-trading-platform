...
const AppDataSource = new typeorm_1.DataSource({
    ...
    entities: [user_entity_1.User, product_entity_1.Product, auction_entity_1.Auction, bid_entity_1.Bid],
    synchronize: false,
});
async function seed() {
    ...
    const products = [
        {
            ...
            rarity: product_entity_1.ProductRarity.ULTRA_RARE,
            condition: product_entity_1.ProductCondition.B,
            price: 12800,
            brand: 'Pokemon',
            series: '1st Edition Base Set',
            cardNumber: '4/102',
            listingType: product_entity_1.ListingType.AUCTION_ONLY,
        ...
        },
        {
            ...
            rarity: product_entity_1.ProductRarity.ULTRA_RARE,
            condition: product_entity_1.ProductCondition.A,
            price: 6800,
            brand: 'Konami',
            series: 'LOB',
            cardNumber: 'LOB-001',
        ...
        },
        {
            ...
            rarity: product_entity_1.ProductRarity.ULTRA_RARE,
            condition: product_entity_1.ProductCondition.S,
            price: 25000,
        ...
        },
        {
            ...
            rarity: product_entity_1.ProductRarity.SUPER_RARE,
            condition: product_entity_1.ProductCondition.A,
            price: 3200,
            brand: 'Bandai',
            series: 'Ultra Medal Series',
            cardNumber: 'N/A',
            listingType: product_entity_1.ListingType.SALE_ONLY,
    ...
    for (const productData of products) {
        ...
        if (product.listingType === product_entity_1.ListingType.AUCTION_ONLY) {
