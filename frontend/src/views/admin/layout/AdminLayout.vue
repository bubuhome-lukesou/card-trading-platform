...
.nav-item.active { background: linear-gradient(135deg, #ef4444, #f59e0b); color: white; }
...
.mobile-nav-toggle:active { background: linear-gradient(135deg, #ef4444, #f59e0b); border-color: transparent; }
...
.mobile-nav-item.active { background: linear-gradient(135deg, #ef4444, #f59e0b); border-color: transparent; color: white; }
